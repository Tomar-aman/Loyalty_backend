...
from users.views import AppleNativeLoginView, PopularCityListView, ProfileView, SignupView, OTPVerifyView, ResendOTPView, CompleteSignUpView, LogoutView, DeleteUserView, GoogleLoginView, CountryListView, CityListView, UserSearchHistoryView
...
urlpatterns = [
    ...
    path('apple-auth/', AppleNativeLoginView.as_view(), name='apple_native_auth'),
